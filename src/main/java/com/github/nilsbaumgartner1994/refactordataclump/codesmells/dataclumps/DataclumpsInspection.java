...
public class DataclumpsInspection extends LocalInspectionTool {
  ...
  /**
   * This is called in inspection configuration in settings to allow the user to change the required
   * thresholds to detect data clumps instances. All required swing elements are created here and
   * added to a JPanel element.
   *
